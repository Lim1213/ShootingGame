...
public class ShootingView extends SurfaceView
        ...
        while (thread != null) {
            ...
            if (scene == S_PLAY) {
                ...
                for (int i = meteos.size() - 1; i >= 0; i--) {
                    ...
                    if (pos.y > H) {
                        init = S_GAMEOVER;
                        g.drawText("SCORE:" + num2str(scorebk, 6), 60 + g.getOriginX(), 10 - (int) g.getFontMetrics().ascent);
                        score = 0;
                    }
                }
    ...
    public void DrawScore() {
        ...
        g.drawText(num2str(score, 6),
                150 + g.getOriginX(), 10 - (int) g.getFontMetrics().ascent);
    ...
    g.setScoreTypeface(segmentFont);
        ...
        g.drawText(num2str(infps, 6),
                350 + g.getOriginX(), 10 - (int) g.getFontMetrics().ascent);
